#!/usr/bin/env python3
"""
MORNING BRIEFING BUILDER - v2.1 (Fixed Notion Query)
"""
import os
import json
import random
...
def fetch_notion_articles() -> List[Dict]:
    """Fetch recent articles from Notion - FIXED"""
    ...
    try:
        ...
        for page in results['results']:
            ...
            # Check if page belongs to our database (handle both parent types)
            parent = page.get('parent', {})
            page_db_id = parent.get('database_id') or ''
            
            # Match database ID (handle with or without hyphens)
